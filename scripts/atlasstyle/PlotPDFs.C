...
void PlotBGBuilding(TString wsname)
{
	...
	legEM->AddEntry(h_final_BG_EM,"e#mu PDF = f(#gamma_{i}B_{i}-#frac{1}{2}#muS_{i}+#frac{1}{2}#muS^{cont.}_{i})","l");
	legEM->Draw();
	...
	legME->AddEntry(h_final_BG_ME,"#mue PDF = #gamma_{i}B_{i} + #frac{1}{2}#muS_{i}-#frac{1}{2}#muS^{cont.}_{i}","l");
	legME->Draw();
	...
	BuncertaintyEM2->SetFillColor(kGreen-9);
        ...
        for (int i=0; i<nbins; i++)
        {
                ...
                cout << "Final gamma in bin "+NumberToString(i)+" = " << FinalGamma2[i] << endl;
        }
	...
	BuncertaintyEM3->SetFillColor(kGreen-9);
        ...
        for (int i=0; i<nbins; i++)
        {
                ...
                cout << "Final gamma in bin "+NumberToString(i)+" = " << FinalGamma3[i] << endl;
        }
